...
```
 ...
 hist(Osimilis_raw$GA155 + Osimilis_raw$GB155,breaks = 100)

 data = FilteringCov(data,poplist,dev=2, minCov=5, maxCov = 150)
 data = FilteringFreqExpression(data_filtered,poplist,GAF=0.1, TAF=0.05)
 ...
 ```{r }
 Gfreq = data$GB158/(data$GA158+data$GB158)  
...
freq = as.data.frame(CreateFreqMatrix(Osimilis_Analysis,poplist)) 
